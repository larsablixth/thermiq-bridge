...
eleven state vectors - demo, heating, hot water, hot water while
circulating, pool, buffer tank, alarm, comms lost, unavailable,
all-unknown, and every clamp edge - and compares them **byte for
byte** against
